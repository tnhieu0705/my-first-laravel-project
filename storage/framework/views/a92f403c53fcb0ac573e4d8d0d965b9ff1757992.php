...
<div class="row">
	...
	<div class="col-xl-3 col-sm-3 mb-3">
		<div class="card o-hidden h-100" id="chude-item">
			...
			<a class="card-footer clearfix small z-1" href="<?php echo e(asset('quantri/chude/'.$chude->cd_ma.'/loaisanpham')); ?>" id="<?php echo e($chude->cd_ma); ?>" onclick="getListLoaiSP(this.id)">
				<span class="float-left">Có <?php echo e(count($chude->coLoaiSanPham)); ?> loại sản phẩm</span>
			</a>
		</div>
	</div>
