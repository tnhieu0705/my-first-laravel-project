			...
			<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
				...
				<tbody>
					...
					<tr>
						...
						<td align="left">{{ $sanpham->sp_soLuong }}</td>
						<td align="left">{{ $sanpham->thuocLoaiSanPham->l_ten }}</td>					
						<td align="center">
							<button type="button" class="btn btn-warning btn-xs get-modalImage" data-placement="bottom" data-toggle="modal" data-target="#modalImages" title="Thêm ảnh" onclick="getModalImage({{ $sanpham->sp_ma }})">
								<i class="fa fa-fw fa-picture-o"></i>
							</button>
							<button type="button" class="btn btn-info btn-xs get-modalEdit" data-toggle="modal" data-target="#modal-create" data-placement="bottom" title="Chỉnh sửa" onclick="getModalEdit({{ $sanpham->sp_ma }})">
								<i class="fa fa-fw fa-pencil-square-o"></i>
							</button>
							<button type="button" class="btn btn-danger btn-xs xoa" data-placement="bottom" title="Xóa" onclick="deleteProduct({{ $sanpham->sp_ma }})">
